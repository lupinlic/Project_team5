...
const Product = () => {
  ...
  useEffect(() => {
    ...
    if (category_Id) {
      axios
        .get(`${apiUrl}/api/categorys/${category_Id}/products`)
        .then((response) => {
      ...
      axios
        .get(`${apiUrl}/api/categorys/${category_Id}`)
        .then((response) => {
          // Truy cập vào phần "data" của API trả về và đặt vào state
    ...
    if (params) {
      axios
        .get(`${apiUrl}/api/getconditionOfProducts`, { params })
        .then((response) => {
          // Truy cập vào phần "data" của API trả về và đặt vào state
          setData(response.data.data);
  ...
  const handleCheckboxChange = (value) => {
    if (selectedFilter === value) {
      ...
      if (value === "all") {
        ...
        setFilteredProducts(
          data.filter((product) => product.product_price < 100000)
        );
      } else if (value === "between_100_200") {
        setFilteredProducts(
          data.filter(
            (product) =>
              product.product_price >= 100000 && product.product_price <= 200000
          )
        );
        ...
        setFilteredProducts(
          data.filter(
            (product) =>
              product.product_price >= 200000 && product.product_price <= 300000
          )
        );
        ...
        setFilteredProducts(
          data.filter(
            (product) =>
              product.product_price >= 300000 && product.product_price <= 500000
          )
        );
        ...
        setFilteredProducts(
          data.filter(
            (product) =>
              product.product_price >= 500000 &&
              product.product_price <= 1000000
          )
        );
      } else if (value === "above_1000") {
        setFilteredProducts(
          data.filter((product) => product.product_price >= 1000000)
        );
      }
    }
  };
  ...
  return (
    <div style={{ margin: "30px 0" }}>
      ...
      <h6 id="menuButton" className="">
        <FontAwesomeIcon icon={faList} onClick={openMenu} />
        Danh mục
      </h6>
      {/* menu */}
      <div
      ...
      >
          ...
          <form>
            ...
            <div className="form-check m-2">
              <input
                ...
                onChange={() => handleCheckboxChange("under_100")}
                id="under_100"
              />
              <label
                className="form-check-label"
            ...
            <div className="form-check m-2">
              <input
                ...
                onChange={() => handleCheckboxChange("between_100_200")}
                id="between_100_200"
              />
              <label
                className="form-check-label"
            ...
            <div className="form-check m-2">
              <input
                ...
                type="checkbox"
                defaultValue
                value="between_200_300"
                checked={selectedFilter === "between_200_300"} // Kiểm tra checkbox đã chọn
                onChange={() => handleCheckboxChange("between_200_300")}
                id="between_200_300"
              />
              <label
                className="form-check-label"
            ...
            <div className="form-check m-2">
              <input
                ...
                type="checkbox"
                defaultValue
                value="between_300_500"
                checked={selectedFilter === "between_300_500"} // Kiểm tra checkbox đã chọn
                onChange={() => handleCheckboxChange("between_300_500")}
                id="between_300_500"
              />
              <label
                className="form-check-label"
            ...
            <div className="form-check m-2">
              <input
                ...
                onChange={() => handleCheckboxChange("between_500_1000")}
                id="between_500_1000"
              />
              <label
                className="form-check-label"
            ...
            <div className="form-check m-2">
              <input
                ...
                onChange={() => handleCheckboxChange("above_1000")}
                id="above_1000"
              />
              <label
                className="form-check-label"
        ...
        <ul className="list-group mb-3">
          <li
            ...
            style={{ backgroundColor: "#e5677d", border: "none" }}
          >
            DANH MỤC SẢN PHẨM
          </li>
          <li className="list-group-item">
            <img
              src="https://duocpham1.haiphongweb.com/wp-content/uploads/2017/09/icon11.png"
              alt=""
            />
            <Link to="/Product/2">Sữa rửa mặt</Link>
          </li>
          <li className="list-group-item">
            <img
              src="https://duocpham1.haiphongweb.com/wp-content/uploads/2017/09/trang-diem-2.png"
              alt=""
            />
            <Link to="/Product/1">Tẩy trang</Link>
          </li>
          <li className="list-group-item">
            <img
              src="https://duocpham1.haiphongweb.com/wp-content/uploads/2017/09/salon-toc.png"
              alt=""
            />
            <Link to="/Product/3">Mặt nạ</Link>
          </li>
          <li className="list-group-item">
            <img
              src="https://duocpham1.haiphongweb.com/wp-content/uploads/2017/09/duong-the.png"
              alt=""
            />
            <Link to="/Product/4">Nước hoa hồng</Link>
          </li>
          <li className="list-group-item">
            <img
              src="https://duocpham1.haiphongweb.com/wp-content/uploads/2017/09/nuoc-hoa-1.png"
              alt=""
            />
            <Link to="/Product/5">Dưỡng ẩm</Link>
          </li>
          <li className="list-group-item">
            <img
              src="https://duocpham1.haiphongweb.com/wp-content/uploads/2017/09/dac-tri.png"
              alt=""
            />
            <Link to="/Product/8">Chăm sóc tóc</Link>
          </li>
          <li className="list-group-item">
            <img
              src="https://duocpham1.haiphongweb.com/wp-content/uploads/2017/09/icon11.png"
              alt=""
            />
            <Link to="/Product/7">Trang điểm</Link>
          </li>
          <li className="list-group-item">
            <img
              src="https://duocpham1.haiphongweb.com/wp-content/uploads/2017/09/trang-diem-2.png"
              alt=""
            />
            <Link to="/Product/6">Dưỡng thể</Link>{" "}
          </li>
        </ul>
      </div>
      {/* main */}
                      ...
                      <div className="col-md-3 p-3 col-6" key={item.id}>
                        ...
                        >
                          ...
                          >
                            ...
                            <Link to={`/Product_detail/${item.product_id}`}>
                              <FontAwesomeIcon
                                icon={faShoppingCart}
                                style={{ color: "red" }}
                              />
