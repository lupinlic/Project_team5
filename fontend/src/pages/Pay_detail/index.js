...
function Pay() {
     ...
     */
     ...
     //   1.các đối tượng cần đc ưu tiên lấy trước
        ...
        useEffect(() => {
            ...
            const carts_session = sessionStorage.getItem('Product_detail');
            const carts_total = sessionStorage.getItem('Product_detailTotal');
    ...
    useEffect(()=>{
        if(Order_id!==null && Order_id!==undefined){
            ...
            sessionStorage.removeItem('Product_detailTotal');
            navigate('/ThankYou')
        }
    },[Order_id])
