...
function Header() {
    ...
    const handleClickOutside = (event) => {
        if (
            (settingsRefMobile.current && !settingsRefMobile.current.contains(event.target)) &&
            (settingsRefDesktop.current && !settingsRefDesktop.current.contains(event.target))
        ) {
                ...
                <div className="container py-3">
                    <div className="row align-items-center">
                        ...
                        <div className="col-1 d-block d-md-none">
                            <div className="fs-3 text-dark" onClick={toggleSettings} ref={settingsRefMobile}> <FontAwesomeIcon icon={faUser} /> </div>
                            {isSettingsOpen && (
                                <div className='account_child' style={{ zIndex: '1050', position: 'absolute', backdropFilter: 'blur(18px)', padding: '20px', width: '250px', left: '20%' }}
                        ...
                        <div className="col-6 col-md-3 d-none d-md-block">
                            <div className="row">
                                ...
                                <div className="col-md " onClick={toggleSettings} ref={settingsRefDesktop} style={{ position: 'relative', cursor: 'pointer' }}>
